...
import audi from '../../../../assets/car_brands/dodge.webp'
import tick from '../../../../assets/orange_tick.svg'

const Manufacturer = () => {
  return (
    <Menu menuBtnText = 'יצרן'>
    <Box display={'flex'} flexDirection={'column'} padding={'1rem'} width={'320px'}>
        <OutlinedInput  size='small'/>
        <Text color='grey' fontWeight={'500'} fontSize={'14px'} paddingTop={'0.6rem'}>ניתן לבחור עד 4 יצרנים</Text>
             {/* chips  */}
        ...
        <List dense sx={{ width: '100%',maxHeight : 300,overflow : 'auto'}}>
            ...
            >
            <Box display={'flex'}>
                <Image src={audi} width={'30px'} height={'30px'} borderRadius={'50%'}/>
